...
Tracking can also present new challenges and harms:

- Through mis-use of a design.
- Through mis-use of tracked data.

Any problem where people gather or seek value in personal data
introduces opportunities and challenges in designing for interaction around that data.
