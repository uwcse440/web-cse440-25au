...
Revisit the course theme description in <SiteLink linkKey={SiteLinks.milestone_1_top}/> if that is helpful in your brainstorming.
...
One way to help yourself identify related problems, goals, and opportunities 
is to consider a hierarchy of opportunities that result from asking "Why?". 
In the context of a budgeting app, for example:
...
Examples of brainstorms are linked from prior offerings,
but be sure your submission is designed for the format, requirements, and emphasis of this assignment:

- <AppLink href={projectSamples.m1_a11.url}>Samples Submissions</AppLink> in Autumn 2024
