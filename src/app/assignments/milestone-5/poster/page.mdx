...
- <a href={Paths.basePath + pathPosterTemplateA} target="_blank">Powerpoint Template A</a>
- <a href={Paths.basePath + pathPosterTemplateB} target="_blank">Powerpoint Template B</a>
- <a href={Paths.basePath + pathPosterTemplateC} target="_blank">Powerpoint Template C</a>
...
<ProjectMilestoneSamples assignment='m5_poster' />
