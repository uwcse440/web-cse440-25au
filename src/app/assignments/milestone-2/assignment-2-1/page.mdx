...
Note an interview session might include multiple participants
(e.g., a pair or group interview), 
but is still considered one session.
...
<ProjectMilestoneSamples assignment='m2_a21' />
