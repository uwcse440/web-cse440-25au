...
import imageTeamPerson2 from "public/images/projects/nextLeap/team/czarin.png";
import imageTeamPerson3 from "public/images/projects/nextLeap/team/hasan.png";
...
import thirteen from "public/images/projects/nextLeap/post/13.png";
import fourteen from "public/images/projects/nextLeap/post/14.png";
...
<ProjectImageBlock
    ...
    caption={
        "A smart mirror interface bringing studio-style feedback into independent practice."
    }
    width={4}
    maxHeight={"550px"}
>
...
At the end of the sequence, the system highlights what the dancer accomplished. A session summary displays the *first* and *most recent* attempts side by side, along with a short explanation of what has improved. This makes progress easy to understand and helps users recognize their own growth that. The final screen congratulates the dancer for meeting their goal and offers next steps, such as setting a new goal or ending the session. These features help users finish with a sense of progress and motivation to continue improving.
...
<ProjectImageBlock
  ...
  caption={
    "Early physical prototype illustrating how multi-modal feedback guides dancers and keeps practice motivating."
  }
  width={5}
  maxHeight={"400px"}
>
...
<ProjectImageBlock
  ...
  caption={
    "Initial storyboard showing how motivational feedback keeps dancers going and helps them notice real progress."
  }
  width={12}
  maxHeight={"800px"}
>
