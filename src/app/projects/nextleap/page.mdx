...
At the end of the sequence, the system highlights what the dancer accomplished. A session summary displays the **first** and **most recent** attempts side by side, along with a short explanation of what has improved. This makes progress easy to understand and helps users recognize the growth that may not feel obvious in the moment. The final screen congratulates the dancer for meeting their goal and offers next steps, such as setting a new goal or ending the session. These features help users finish with a sense of progress and motivation to continue improving.
