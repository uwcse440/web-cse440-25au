...
import sixteen from "public/images/projects/nextLeap/post/16.png";
...
<ProjectImagesBlock
    images={[
        ...
        {   
            src: sixteen,
            alt: "Smart mirror congratulating user once more and suggesting they set a new goal.",
        },
...
<ProjectImageBlock
  image={{
    src: seven,
    alt: "Shot of our physical prototype's multi-modal feedback."
  }}
  caption={
    ...
    images={[
      {
        ...
        caption: (
          <div style={{ textAlign: "center" }}>
            The step-by-step breakdown follows the way instructors scaffold skills in class,
            starting with a safe setup and gradually adding clear corrections as the movement develops.
          </div>
        ),
      },
    ]}
...
<ProjectImageBlock
  image={{
    src: thirteen,
    alt: "Storyboarding showing scenario where supportive feedback boosts esteem of user",
  }}
  caption={
...
<ProjectImageBlock
    image={{
        src: fifteen,
        alt: "Initial prototype of NextLeap.",
    }}
    caption={
...
<ProjectImageBlock
  ...
  caption={
    <div style={{ textAlign: "center" }}>
      The renewed remote makes navigation effortless, adding voice navigation and an arm-strap for smooth control while dancers stay in motion.
    </div>
  }
  width={12}
  maxHeight={"400px"}
...
<ProjectImagesBlock
  images={[
    {
      src: eleven,
      alt: "Initial mockup vs. final mock up of NextLeap showing a prerequisite check pop-up asking whether the user has learned first and second position before continuing.",
      caption:
...
<ProjectImagesBlock
    images={[
        {
            src: twelve,
            alt: "Initial mockup vs final mockup of the tutorial screen being displayed",
            caption: "A small, always-visible tutorial gives the continuous guidance that ensures they remain oriented"
        },
    ]}
    direction={"column"}
    width={6.0}
