...
<ProjectImagesBlock
    ...
    direction={"row"}
    caption={
        "NextLeap provides step-by-step tutorials, guided practice modes, and real-time corrections to help dancers learn safely, build proper technique, and grow confident in their movement."
    }
    width={12}
    maxHeight={"400px"}
/>
